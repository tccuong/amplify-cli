...
const createCustomer = async (email: string, addressList: string[], username: string): Promise<$TSAny> => {
  const result = await GRAPHQL_CLIENT.query(
...
const updateCustomer = async (email: string, addressList: string[], username: string): Promise<$TSAny> => {
  const result = await GRAPHQL_CLIENT.query(
...
const getCustomer = async (email: string): Promise<$TSAny> => {
  const result = await GRAPHQL_CLIENT.query(
...
const createOrder = async (customerEmail: string, orderId: string, createdAt: string = new Date().toISOString()): Promise<$TSAny> => {
  const result = await GRAPHQL_CLIENT.query(
...
const updateOrder = async (customerEmail: string, createdAt: string, orderId: string): Promise<$TSAny> => {
  const result = await GRAPHQL_CLIENT.query(
...
const deleteOrder = async (customerEmail: string, createdAt: string): Promise<$TSAny> => {
  const result = await GRAPHQL_CLIENT.query(
...
const getOrder = async (customerEmail: string, createdAt: string) : Promise<$TSAny> => {
  const result = await GRAPHQL_CLIENT.query(
...
const listOrders = async (customerEmail: string, createdAt: ModelStringKeyConditionInput, sortDirection: string): Promise<$TSAny> => {
...
const createItem = async (orderId: string, status: string, name: string, createdAt: string = new Date().toISOString()): Promise<$TSAny> => {
  const input = {
...
const updateItem = async (orderId: string, status: string, createdAt: string, name: string): Promise<$TSAny> => {
  const input = {
...
const deleteItem = async (orderId: string, status: string, createdAt: string): Promise<$TSAny> => {
...
const getItem = async (orderId: string, status: string, createdAt: string): Promise<$TSAny> => {
  const result = await GRAPHQL_CLIENT.query(
...
const itemsByStatus = async (status: string, createdAt?: StringKeyConditionInput, limit?: number, nextToken?: string): Promise<$TSAny> => {
  const result = await GRAPHQL_CLIENT.query(
    `query ListByStatus(
...
const createShippingUpdate = async (input: CreateShippingInput): Promise<$TSAny> => {
  const result = await GRAPHQL_CLIENT.query(
...
const listGSIShippingUpdate = async (orderId: string, itemId: $TSAny, sortDirection: string): Promise<$TSAny> => {
...
const updateShippingUpdate = async (input: UpdateShippingInput): Promise<$TSAny> => {
  const result = await GRAPHQL_CLIENT.query(
...
const getShippingUpdates = async (orderId: string): Promise<$TSAny> => {
  const result = await GRAPHQL_CLIENT.query(
...
const getShippingUpdatesWithNameFilter = async (orderId: string, name: string): Promise<$TSAny> => {
  const result = await GRAPHQL_CLIENT.query(
